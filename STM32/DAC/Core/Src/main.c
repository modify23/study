...
void HAL_ADC_ConveCpltCallback(ADC_HandleTypeDef *hadc);
/* USER CODE BEGIN PFP */
...
//		}
		...
		sprintf(uart_buf, "Current level : %d, VR Value : %d\r\n",current_level, adc_value);
